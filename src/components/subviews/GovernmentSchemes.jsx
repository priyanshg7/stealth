...
import { evaluateSchemeEligibility, extractSearchFilters, parseSchemeDocs, calculateDocProgress } from '../../services/schemesService';
import { SchemeCard } from '../schemes/SchemeCard';

const localEvaluateScheme = evaluateSchemeEligibility;
